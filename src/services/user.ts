...
export const  getUserPostagenCount = async (slug: string) => {
...
export const checkIFollows = async (user1Slug: string, user2Slug: string) => {
...
export const getUserSuggestions = async (slug: string) => {
    ...
    type Suggestion = 
        Pick<Prisma.UserGetPayload<Prisma.UserDefaultArgs>,
        "name" | "avatar" | "slug"
    >;
